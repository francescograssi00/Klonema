...
# Componenti Chimera
*Case (hardware)*: è il contenitore metallico o plastico che racchiude e protegge i componenti hardware di un computer (scheda madre, CPU, GPU, alimentatore). La sua funzione principale è fornire supporto strutturale, isolamento elettromagnetico e garantire il corretto flusso d'aria per il raffreddamento dei circuiti. All’interno della chimera rappresenta il ponte osmotico tra la carne e il codice: la sua ventola non raffredda solo componenti elettronici, ma dissipa il calore dei pensieri organici, permettendo alla pesantezza della materia di tradursi, attraverso un atto di fiducia, nella leggerezza asettica del clone.


*Tubero*: è una parte ingrossata del fusto o della radice di una pianta, situata generalmente nel sottosuolo. La sua funzione principale è quella di organo di riserva, in cui la pianta accumula nutrienti (principalmente amido) per sopravvivere a condizioni avverse e permettere la riproduzione vegetativa nella stagione successiva.  Assume un ruolo importante nella moltiplicazione vegetativa (o propagazione clonale) della pianta che li produce. All’interno della chimera rivendica la necessità della pesantezza, del fango e della mortalità. 
